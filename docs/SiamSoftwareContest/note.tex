...
So has \href{http://lapm.readthedocs.io/en/latest/}{LAPM}. The bgc-md package has the documentation of the command-line tool which is available after installation \texttt{render -h} 
