...
setup(name='bgc_md',
        ...
        'console_scripts': [
                ...
                ,'generate_minimal_model_report= bgc_md.reports:generate_minimal_model_report' # ...
                ,'generate_minimal_model_reports= bgc_md.reports:generate_minimal_model_reports' # ...
                ]
        },
        install_requires=[
            "bibtexparser"
