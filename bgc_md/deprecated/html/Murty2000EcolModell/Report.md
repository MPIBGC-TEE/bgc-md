...
$T_{a}$|Mean air temperature|-|parameter|-
$Q_{10}$|-|-|parameter|-
$Q_{010}$|-|-|parameter|-
...
$\sigma$|Leaf area per unit carbon|-|variable|$m^{2}\cdot kgC^{-1}$
...
$NPP$|Annual net primary production|$NPP=GPP-\left(R_{c}+R_{m}\right)$|variable|$kgC\cdot m^{-2}\cdot year^{-1}$
