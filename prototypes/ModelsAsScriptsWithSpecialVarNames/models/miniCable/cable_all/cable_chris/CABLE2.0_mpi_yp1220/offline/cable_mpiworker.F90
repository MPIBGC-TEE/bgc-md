...
CONTAINS
   ...
   print*,'before open',associated(casabiome%ivt2)
   ...
   ! file themselves
   print*,'before worker Bcast',associated(casabiome%ivt2)
   ...
   ! the master
   print*,'before worker cable_para',associated(casabiome%ivt2)
...
SUBROUTINE worker_casa_params (comm,casabiome,casapool,casaflux,casamet,&
  ...
  print*,'in worker_casa_param',ASSOCIATED(casabiome%ivt2),associated(casabiome%xkleafdrymax)
...
print*,'in worker_casa_param, before get address',bidx,displs(bidx)
  ...
  blen(bidx) = mvtype * extr2
  print*,'after get address rootdepth'
...
!===================================================================
  ...
  print*,'after get address plantrate'
  ...
  blen(bidx) = r2len
  print*,'after get address dPsoiloccdt'
  ...
  print*,'after get address doyphase'
  ! MPI: sanity check
  IF (bidx /= ntyp) THEN
...
SUBROUTINE worker_intype (comm,met,veg)
  ...
  ! declaration in cable_define_types.F90
   ...
   print*,'in worker_casa_param, end of get address'
  ...
  types = MPI_BYTE
   ...
   print*,'in worker_casa_param, before create struct'
