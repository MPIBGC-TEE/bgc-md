...
! print*,'rplant',veg%iveg(5002),casaflux%Cgpp(5002)*365,casaflux%Cnpp(5002)*365,casamet%glai(5002)
...
!  labile C pool will be computed casa_labile
  ...
  !MPI
!  PRINT *, 'plant turnover = ', casapool%cplant(5002,:)*casaflux%kplant(5002,:)
!  PRINT *, 'plant C =',casapool%cplant(5002,:)
!  PRINT *, 'allocation fraction',casaflux%fracCalloc(5002,:)
!  PRINT *, 'Cnpp',casaflux%Cnpp(5002)
